...
const handleModeSwitch = () => {
  ...
  return (
    <>
      {isLoaded && (
        <nav
          className={`w-full px-24 flex justify-between items-center py-6 
           top-0 z-30 transition-all duration-300 ${
            navFixed || userInfo
        ...
        >
          <div>
            <Link href="/">
             ...
             {/* <span className="text-black text-4xl font-bold">𝒇𝒓𝒆𝒆𝒍𝒂𝒏𝒄𝒆𝒉𝒖𝒃</span> */}
          </div>
          <div
