...
import { EDIT_GIG_DATA, EDIT_GIG_ROUTE, GET_GIG_DATA, HOST } from "../../../utils/constants";
      ...
      <form action="" className="flex flex-col gap-5 mt-10">
        <div className="grid grid-cols-2 gap-11">
          <div>
            ...
            <span className="text-black">Gig Title</span>
            </label>
            <input
              name="title"
              value={data.title}
        ...
        <div>
          ...
          <span className="text-black">Gig Description</span>
          </label>
          <textarea
            id="description"
        ...
        <div className="grid grid-cols-2 gap-11">
          ...
          <div>
            ...
            <span className="text-black">Revisions</span> 
            </label>
            <input
              type="number"
              id="revision"
        ...
        <div className="grid grid-cols-2 gap-11">
          ...
          <div>
            ...
            <span className="text-black"> Gig Images</span>
            </label>
            <div>
        ...
        <div className="grid grid-cols-2 gap-11">
          ...
          <div>
            ...
            <span className="text-black">Gig Price ( $ )</span>
            </label>
            <input
              type="number"
              className={`${inputClassName} w-1/5`}
